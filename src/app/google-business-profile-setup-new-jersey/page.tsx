...
export const metadata: Metadata = generateMeta({
  ...
  path: "/google-business-profile-setup-new-jersey",
});
...
const serviceSchema = {
  ...
  url: `${SITE.url}/google-business-profile-setup-new-jersey`,
};
...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    },
    {
      ...
      position: 3,
      name: "Google Business Profile Setup New Jersey",
      item: `${SITE.url}/google-business-profile-setup-new-jersey`,
    },
  ],
};
