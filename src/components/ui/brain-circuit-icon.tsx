      ...
      >
        ...
        >
          <motion.path
            ...
            d="M12 5a3 3 0 1 0-5.997.125 4 0-2.526 5.77 .556 6.588A4 12 18Z"
          />
          <motion.path className="circuit-line" d="M9 13a4.5 4.5 0 3-4" />
          <motion.path
            className="brain-outline"
            d="M6.003 5.125A3 3 0 6.401 6.5"
          />
          <motion.path
            className="brain-outline"
            d="M3.477 10.896a4 4 0 1 .585-.396"
          />
          <motion.path
            className="brain-outline"
            d="M6 18a4 4 0 1-1.967-.516"
          />
          <motion.path className="circuit-line" d="M12 13h4" />
          <motion.path className="circuit-line" d="M12 18h6a2 2 0 1 2v1" />
          <motion.path className="circuit-line" d="M12 8h8" />
          <motion.path className="circuit-line" d="M16 8V5a2 2 0 1 2-2" />
          <motion.circle
