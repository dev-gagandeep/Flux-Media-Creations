...
export default function HomeV2() {
  return (
    <>
      ...
      <section id="business-shift" className="bg-pulse-light py-16 md:py-24">
      ...
      <section className="bg-white py-16 md:py-24"><div className="flux-shell"><SectionHead kicker="The problem" title="The problem was never a lack of tools. It's a lack of connection." />
      ...
      <section className="bg-pulse-light py-16 md:py-24"><div className="flux-shell"><SectionHead kicker="Industries" title="Built first for businesses where every missed response costs a customer." />
      ...
      <section className="bg-white py-16 md:py-24"><div className="flux-shell"><SectionHead kicker="Why Flux" title="We are not selling you a website. We are building the system behind it." />
